...
class _CallOutAllIndividualRepostsStrategy(RepostCalloutStrategy):
    ...
    @staticmethod
    def get_required_strings() -> List[str]:
        return ["repost_alert", "first_repost_callout", "intermediary_callouts"]
...
class _CallOutNumberOfRepostsStrategy(RepostCalloutStrategy):
    ...
    @staticmethod
    def get_required_strings() -> List[str]:
        return ["first_repost_callout", "single_callout_one_repost_options", "single_callout_x_num_reposts_options"]
